                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            // Static table for complexity
                            Table(
                              columnWidths: {
                                // First column wider to fit the text
                                0: FlexColumnWidth(2),
                                // Other columns standard width
                                for (int i = 1; i < 10; i++) i: FlexColumnWidth(1),
                              },
                              ...
                              children: List.generate(10, (rowIndex) {
                                return TableRow(
                                  children: List.generate(10, (colIndex) {
                                    // Conditional content for specific cells
                                    Widget cellContent = SizedBox(); // Empty by default
                                    ...
                                    if (rowIndex == 0 && colIndex == 0) {
                                      ...
                                      cellContent = Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text("Structure", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                      ...
                                      cellContent = Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text("Complexity", style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                      ...
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Array", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 4 && colIndex == 0) {
                                      // Fifth row, first column (Stack)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Stack", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 5 && colIndex == 0) {
                                      // Sixth row, first column (Queue)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Queue", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 6 && colIndex == 0) {
                                      // Seventh row, first column (Singly Linked List)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Singly", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("Linked", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("List", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 7 && colIndex == 0) {
                                      // Eighth row, first column (Doubly Linked List)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Doubly", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("Linked", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("List", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ...
                                      // Ninth row, first column (Binary Search Tree)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Binary", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("Search", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("Tree", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 9 && colIndex == 0) {
                                      // Tenth row, first column (Hash Table)
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Hash", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                            Text("Table", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      );
                                    } else if (rowIndex == 0 && colIndex == 9) {
                                      // Last row, Space column
                                      cellContent = Center(
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          crossAxisAlignment: CrossAxisAlignment.center,
