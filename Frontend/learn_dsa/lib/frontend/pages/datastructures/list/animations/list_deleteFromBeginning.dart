...
class LinkedListDeleteFromBeginningNode extends StatefulWidget {
  @override
  State<LinkedListDeleteFromBeginningNode> createState() => _LinkedListDeleteFromBeginningNodeState();
}

class _LinkedListDeleteFromBeginningNodeState extends State<LinkedListDeleteFromBeginningNode> {
  List<int> nodes = [20, 40, 30, 50]; // Example list with 4 elements
  bool isInserting = false;

  void _deleteNodeFromBeginning() async {
    ...
    setState(() {
      nodes.removeAt(0); // Remove the first node from the list
      isInserting = false;
    });
  }
      ...
      builder: (context, constraints) {
        ...
        return Column(
          children: [
            ...
            SizedBox(height: 32),
            ElevatedButton(
              onPressed: isInserting ? null : _deleteNodeFromBeginning,
              child: Text('deleteFromBeginning(head)'),
            ),
          ],
        );
      },
...
class DoublyLinkedListDeleteFromBeginning extends StatefulWidget {
  @override
  State<DoublyLinkedListDeleteFromBeginning> createState() =>
      _DoublyLinkedListDeleteFromBeginningState();
}

class _DoublyLinkedListDeleteFromBeginningState
    extends State<DoublyLinkedListDeleteFromBeginning> {
  List<int> nodes = [20, 40, 30, 50];
  bool isDeleting = false;

  void _deleteFromBeginning() async {
      ...
      builder: (context, constraints) {
        ...
        return Column(
          children: [
            ...
            SizedBox(height: 32),
            ElevatedButton(
              onPressed: isDeleting ? null : _deleteFromBeginning,
              child: Text('deleteFromBeginning(head)'),
            ),
          ],
        );
