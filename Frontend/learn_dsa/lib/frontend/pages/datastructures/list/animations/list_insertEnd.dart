...
class LinkedListInsertAtEndNode extends StatefulWidget {
  const LinkedListInsertAtEndNode({super.key});
...
class DoublyLinkedListInsertAtEnd extends StatefulWidget {
  const DoublyLinkedListInsertAtEnd({super.key});
...
class CircularLinkedListInsertAtEndNode extends StatefulWidget {
  const CircularLinkedListInsertAtEndNode({super.key});

  @override
  State<CircularLinkedListInsertAtEndNode> createState() => _CircularLinkedListInsertAtEndNodeState();
}

class _CircularLinkedListInsertAtEndNodeState extends State<CircularLinkedListInsertAtEndNode> {
  List<int> nodes = [20, 40, 30];
  bool isInserting = false;
