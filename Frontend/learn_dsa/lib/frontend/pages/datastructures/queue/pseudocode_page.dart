              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_1),
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_2),
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_3),
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_4),
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_5),
                    _buildExplanationRow(AppLocalizations.of(context)!.queue_naming_conv_6),
                  ],
                ),
              ),
            ),
