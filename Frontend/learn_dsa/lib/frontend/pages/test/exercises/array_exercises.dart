...
import '../../datastructures/array/animations/array_animations.dart';
import '../tests_page.dart';

class ArrayExercisesPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;

  const ArrayExercisesPage({Key? key, required this.toggleTheme, required this.userId}) : super(key: key);

  @override
  State<ArrayExercisesPage> createState() => _ArrayExercisesPageState();
}

class _ArrayExercisesPageState extends State<ArrayExercisesPage> with SingleTickerProviderStateMixin {
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                AppLocalizations.of(context)!
                                    .array_page_exercises_animation_description,
                                style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.grey,
                                ),
