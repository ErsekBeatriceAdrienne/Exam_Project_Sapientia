...
class QueueExercisesPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;

  const QueueExercisesPage({Key? key, required this.toggleTheme, required this.userId}) : super(key: key);

  @override
  State<QueueExercisesPage> createState() => _QueueExercisesPageState();
}

class _QueueExercisesPageState extends State<QueueExercisesPage> with SingleTickerProviderStateMixin {
                      ...
                      Column(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(AppLocalizations.of(context)!.queue_button_text,
                                style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF255f38),
                              ...
                              Text(AppLocalizations.of(context)!.circular_queue_button_text,
                                style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF255f38),
