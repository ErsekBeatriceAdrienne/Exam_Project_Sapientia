...
class BSTTestEasyResultsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;
  final Map<int, String>? selectedAnswers;

  const BSTTestEasyResultsPage({Key? key, required this.toggleTheme, required this.userId, required this.selectedAnswers}) : super(key: key);

  @override
  State<BSTTestEasyResultsPage> createState() => _BSTTestEasyResultsPageState();
}

class _BSTTestEasyResultsPageState extends State<BSTTestEasyResultsPage> with SingleTickerProviderStateMixin {
