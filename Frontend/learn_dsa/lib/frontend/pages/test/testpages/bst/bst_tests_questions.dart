...
class BSTTestsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;

  const BSTTestsPage({Key? key, required this.toggleTheme, required this.userId}) : super(key: key);

  @override
  State<BSTTestsPage> createState() => _BSTTestsPageState();
}

class _BSTTestsPageState extends State<BSTTestsPage> with SingleTickerProviderStateMixin {
                                  ...
                                  // If we answered all questions
                                    ...
                                    Navigator.pushReplacement(
                                      ...
                                      Essentials().createSlideRoute(
                                          BSTTestEasyResultsPage(toggleTheme: widget.toggleTheme, userId: widget.userId, selectedAnswers: selectedAnswers)
                                      ),
                                    );
                                  }
                                },
