...
import 'all_tests_results.dart';

class AllTestsQuestionsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;

  const AllTestsQuestionsPage({Key? key, required this.toggleTheme, required this.userId}) : super(key: key);

  @override
  State<AllTestsQuestionsPage> createState() => _AllTestsQuestionsPageState();
}

class _AllTestsQuestionsPageState extends State<AllTestsQuestionsPage> with SingleTickerProviderStateMixin {
                ...
                leading: TextButton.icon(
                  ...
                  onPressed: () {
                    Navigator.pop(
                      context,
                      CupertinoPageRoute(
                        builder: (_) => AllDataStructureTestPage(
