...
class AllTestEasyResultsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;
  final Map<int, String>? selectedAnswers;

  const AllTestEasyResultsPage({Key? key, required this.toggleTheme, required this.userId, required this.selectedAnswers}) : super(key: key);

  @override
  State<AllTestEasyResultsPage> createState() => _AllTestEasyResultsPageState();
}

class _AllTestEasyResultsPageState extends State<AllTestEasyResultsPage> with SingleTickerProviderStateMixin {
