...
class HashTestEasyResultsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;
  final Map<int, String>? selectedAnswers;

  const HashTestEasyResultsPage({Key? key, required this.toggleTheme, required this.userId, required this.selectedAnswers}) : super(key: key);

  @override
  State<HashTestEasyResultsPage> createState() => _HashTestEasyResultsPageState();
}

class _HashTestEasyResultsPageState extends State<HashTestEasyResultsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _dataFuture = _firestoreService.getAllExercisesFromDocument(FirestoreDocs.hash_tests_doc);
  }
