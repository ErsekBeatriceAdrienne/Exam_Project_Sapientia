...
class StackTestEasyResultsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;
  final Map<int, String>? selectedAnswers;

  const StackTestEasyResultsPage({Key? key, required this.toggleTheme, required this.userId, required this.selectedAnswers}) : super(key: key);

  @override
  State<StackTestEasyResultsPage> createState() => _StackTestEasyResultsPageState();
}

class _StackTestEasyResultsPageState extends State<StackTestEasyResultsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _dataFuture = _firestoreService.getAllExercisesFromDocument(FirestoreDocs.stack_tests_doc);
  }
