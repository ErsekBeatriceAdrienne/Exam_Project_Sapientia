...
class StackTestsQuestionsPage extends StatefulWidget {
...
class _StackTestsQuestionsPageState extends State<StackTestsQuestionsPage> with SingleTickerProviderStateMixin {
