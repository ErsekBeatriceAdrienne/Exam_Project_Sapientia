...
class ListTestsResultsPage extends StatefulWidget {
  final VoidCallback toggleTheme;
  final String? userId;
  final Map<int, String>? selectedAnswers;

  const ListTestsResultsPage({Key? key, required this.toggleTheme, required this.userId, required this.selectedAnswers}) : super(key: key);

  @override
  State<ListTestsResultsPage> createState() => _ListTestsResultsPageState();
}

class _ListTestsResultsPageState extends State<ListTestsResultsPage> with SingleTickerProviderStateMixin {
